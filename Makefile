NAME = main
OBJECTS = src/common/keyboardish.o src/common/ps2_helpers.o src/common/communicator.o src/common/magstripe.o src/common/storage.o src/common/servo.o src/common/stepper_driver.o src/common/valve.o src/common/mcp3008.o src/common/button.o src/common/breathalyzer.o src/common/modified_pwm.o
